...
**Project is pinned to Godot 4.5.1.** Version 4.6 changes are listed for
reference only — do NOT apply 4.6 migration steps to this project.

## 4.6 (Jan 2026 — NOT USED, FOR REFERENCE ONLY)
