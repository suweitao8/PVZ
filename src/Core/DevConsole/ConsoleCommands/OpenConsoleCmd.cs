...
{
	private static readonly IReadOnlyCollection<string> _options = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[5] { "logs", "saves", "root", "build-logs", "loc-override" });
