...
public static class CreatureCmd
{
	...
	{
		return await Damage(choiceContext, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(target), amount, props, dealer, null);
	}
	...
	{
		return await Damage(choiceContext, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(target), damageVar.BaseValue, damageVar.Props, dealer, cardSource);
	}
	...
	{
		return await Damage(choiceContext, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(target), amount, props, dealer, cardSource);
	}
	...
	{
		await Kill(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(creature), force);
	}
	...
	private static async Task KillWithoutCheckingWinCondition(Creature creature, bool force, int recursion = 0)
	{
		...
		CombatState combatState = creature.CombatState;
		IRunState runState = IRunState.GetFrom(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(creature));
