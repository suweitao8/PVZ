...
public static class CardCmd
{
	...
	{
		await Discard(choiceContext, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardModel>(card));
	}
	...
	{
		Upgrade(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardModel>(card), style);
	}
