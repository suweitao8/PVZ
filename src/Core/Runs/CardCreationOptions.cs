...
public record CardCreationOptions
{
	...
	public static CardCreationOptions ForRoom(Player player, RoomType roomType)
	{
		...
		return new CardCreationOptions(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardPoolModel>(player.Character.CardPool), source, roomType switch
		{
