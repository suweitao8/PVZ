...
public class Logger
{
	...
	private static readonly bool _isRunningFromGodotEditor = GetIsRunningFromGodotEditor();

	public static LogLevel GlobalLogLevel { get; set; } = LogLevel.Info;

	private static readonly ILogPrinter _logPrinter = ((!_isRunningFromGodotEditor) ? new ConsoleLogPrinter() : new EditorLogPrinter());
