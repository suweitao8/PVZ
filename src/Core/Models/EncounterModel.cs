...
public abstract class EncounterModel : AbstractModel
{
	...
	public IEnumerable<string> MapNodeAssetPaths
	{
		get
		{
			...
			{
				return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<string>(BossNodePath);
			}
			return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[2]
			{
				BossNodePath + ".png",
