...
public sealed class GigantificationPotion : PotionModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<GigantificationPower>(1m));
