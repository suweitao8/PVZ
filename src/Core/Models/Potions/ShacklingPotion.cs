...
public sealed class ShacklingPotion : PotionModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<StrengthPower>(7m));
