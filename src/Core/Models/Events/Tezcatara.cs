...
{
	public override IEnumerable<CharacterModel> AnyCharacterDialogueBlacklist => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CharacterModel>(ModelDb.Character<Defect>());
