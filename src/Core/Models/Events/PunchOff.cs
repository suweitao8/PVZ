...
public sealed class PunchOff : EventModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new GoldVar(0));
	...
	{
		_punchCts?.Cancel();
		SetEventState(L10NLookup("PUNCH_OFF.pages.I_CAN_TAKE_THEM.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(new EventOption(this, Fight, "PUNCH_OFF.pages.I_CAN_TAKE_THEM.options.FIGHT")));
		return Task.CompletedTask;
	}
	...
	{
		base.Owner.CanRemovePotions = true;
		EnterCombatWithoutExitingEvent<PunchOffEventEncounter>(new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<Reward>(new Reward[2]
		{
			new RelicReward(base.Owner),
