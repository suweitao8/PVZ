...
public sealed class TheArchitect : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		{
			return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(CreateProceedOption());
		}
		CurrentLineIndex = 0;
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine());
	}
	...
	private static AncientDialogueSet DefineDialogues()
	{
		return new AncientDialogueSet
		{
			...
			{
				[CharKey<Ironclad>()] = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientDialogue>(new AncientDialogue[3]
				{
					new AncientDialogue("", "")
					{
						VisitIndex = 0,
				...
				[CharKey<Silent>()] = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientDialogue>(new AncientDialogue[4]
				{
					new AncientDialogue("")
					{
						VisitIndex = 0,
				...
				[CharKey<Defect>()] = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientDialogue>(new AncientDialogue[3]
				{
					new AncientDialogue("", "", "")
					{
						VisitIndex = 0,
				...
				[CharKey<Necrobinder>()] = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientDialogue>(new AncientDialogue[4]
				{
					new AncientDialogue("", "")
					{
						VisitIndex = 0,
				...
				[CharKey<Regent>()] = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientDialogue>(new AncientDialogue[3]
				{
					new AncientDialogue("", "", "")
					{
						VisitIndex = 0,
	...
	private async Task AdvanceDialogue()
	{
		...
		if (CurrentLineIndex < Dialogue.Lines.Count)
		{
			...
			eventOptions = new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine());
		}
		else
		{
			eventOptions = new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(CreateProceedOption());
		}
	...
	private async Task PlayCurrentLine()
	{
		...
		if (CurrentLineIndex == 0)
		{
			SetEventState(_emptyLocString, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(CreateOptionForCurrentLine()));
		}
	}
