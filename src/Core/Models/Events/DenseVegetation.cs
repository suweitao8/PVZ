...
public sealed class DenseVegetation : EventModel
{
	...
	private async Task Rest()
	{
		...
		SetEventState(L10NLookup("DENSE_VEGETATION.pages.REST.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(new EventOption(this, Fight, "DENSE_VEGETATION.pages.REST.options.FIGHT")));
	}
