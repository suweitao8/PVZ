...
public class Orobas : AncientEventModel
{
	...
	public override IEnumerable<EventOption> AllPossibleOptions => new IEnumerable<EventOption>[5]
	{
		...
		OptionPool3,
		DiscoveryTotems,
		new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(PrismaticGemOption)
	...
	private IEnumerable<EventOption> OptionPool2 => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[3]
	{
