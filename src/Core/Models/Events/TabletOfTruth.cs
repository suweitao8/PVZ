...
public sealed class TabletOfTruth : EventModel
{
	...
	private async Task Decipher()
	{
		...
		SetEventState(L10NLookup($"TABLET_OF_TRUTH.pages.DECIPHER_{DecipherCount}.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
		{
