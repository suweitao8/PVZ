...
public sealed class ColossalFlower : EventModel
{
	...
	private async Task ReachDeeper()
	{
		...
		if (NumberOfDigs < 2)
		{
			SetEventState(L10NLookup($"COLOSSAL_FLOWER.pages.REACH_DEEPER_{NumberOfDigs}.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
			{
		...
		{
			SetEventState(L10NLookup("COLOSSAL_FLOWER.pages.REACH_DEEPER_2.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
			{
