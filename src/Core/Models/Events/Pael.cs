...
{
	public override IEnumerable<EventOption> AllPossibleOptions => OptionPool1.Concat(OptionPool2).Concat(OptionPool3).Concat(new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[4] { PaelsClawOption, PaelsToothOption, PaelsLegionOption, PaelsGrowthOption }));
	...
	private IEnumerable<EventOption> OptionPool1 => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[3]
	{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[3] { eventOption, eventOption2, eventOption3 });
	}
}
