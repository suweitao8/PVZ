...
public class Nonupeipe : AncientEventModel
{
	...
	public override IEnumerable<EventOption> AllPossibleOptions => OptionPool.Concat(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(BeautifulBraceletEventOption));

	protected override IEnumerable<DynamicVar> CanonicalVars => Array.Empty<DynamicVar>();

	private IEnumerable<EventOption> OptionPool => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[9]
	{
