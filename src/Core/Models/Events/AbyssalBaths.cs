...
public sealed class AbyssalBaths : EventModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<DynamicVar>(new DynamicVar[3]
	{
		new MaxHpVar(2m),
	...
	{
		await OnImmerse();
		SetEventState(L10NLookup("ABYSSAL_BATHS.pages.IMMERSE.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
		{
	...
	private async Task Linger()
	{
		...
		{
			SetEventState(L10NLookup("ABYSSAL_BATHS.pages.DEATH_WARNING.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
			{
		...
		SetEventState(L10NLookup($"ABYSSAL_BATHS.pages.LINGER{LingerCount}.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
		{
			new EventOption(this, Linger, "ABYSSAL_BATHS.pages.ALL.options.LINGER").ThatDoesDamage(damage),
			new EventOption(this, ExitBaths, "ABYSSAL_BATHS.pages.ALL.options.EXIT_BATHS")
		}));
