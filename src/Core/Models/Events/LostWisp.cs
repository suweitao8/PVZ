...
public sealed class LostWisp : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(array);
	}
	...
	{
		await CardPileCmd.AddCursesToDeck(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardModel>(ModelDb.Card<Decay>()), base.Owner);
