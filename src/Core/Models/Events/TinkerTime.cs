...
public sealed class TinkerTime : EventModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<DynamicVar>(new DynamicVar[12]
	{
	...
	{
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(new EventOption(this, ChooseCardType, "TINKER_TIME.pages.INITIAL.options.CHOOSE_CARD_TYPE"));
	}

	private Task ChooseCardType()
	{
		IEnumerable<EventOption> collection = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[3]
		{
	...
	private Task ChooseRiderEffect()
	{
		...
		{
			CardType.Attack => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<RiderEffect>(new RiderEffect[3]
			{
				RiderEffect.Sapping,
				RiderEffect.Violence,
				RiderEffect.Choking
			}), 
			CardType.Skill => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<RiderEffect>(new RiderEffect[3]
			{
				RiderEffect.Energized,
				RiderEffect.Wisdom,
				RiderEffect.Chaos
			}), 
			CardType.Power => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<RiderEffect>(new RiderEffect[3]
			{
		...
		SetEventState(L10NLookup("TINKER_TIME.pages.CHOOSE_RIDER.description"), new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventOption>(new EventOption[2]
		{
