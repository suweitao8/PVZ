...
public sealed class KnowledgeDemon : MonsterModel
{
	...
	private static readonly IReadOnlyList<IReadOnlyList<IChoosable>> _curseOfKnowledgeSets = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<IReadOnlyList<IChoosable>>(new IReadOnlyList<IChoosable>[3]
	{
		new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<IChoosable>(new IChoosable[2]
		{
