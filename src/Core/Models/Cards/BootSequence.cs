...
public sealed class BootSequence : CardModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new BlockVar(10m, ValueProp.Move));
