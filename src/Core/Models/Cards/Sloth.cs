...
public sealed class Sloth : CardModel, KnowledgeDemon.IChoosable
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<SlothPower>(3m));
