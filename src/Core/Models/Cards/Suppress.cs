...
public sealed class Suppress : CardModel
{
	...
	public override IEnumerable<CardKeyword> CanonicalKeywords => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardKeyword>(CardKeyword.Innate);
