...
public sealed class Fasten : CardModel
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips
	{
		get
		{
			...
			return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<IHoverTip>(new IHoverTip[2]
			{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new DynamicVar("ExtraBlock", 5m));
