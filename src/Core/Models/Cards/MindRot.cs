...
public sealed class MindRot : CardModel, KnowledgeDemon.IChoosable
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<MindRotPower>(1m));
