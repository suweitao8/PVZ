	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		foreach (PowerApplication application in _powerApplications)
		{
			foreach (Creature item in application.targetType switch
			{
				...
				TargetType.AnyEnemy => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(cardPlay.Target), 
				TargetType.Self => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(base.Owner.Creature), 
