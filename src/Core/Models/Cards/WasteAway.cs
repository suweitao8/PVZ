...
public sealed class WasteAway : CardModel, KnowledgeDemon.IChoosable
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<WasteAwayPower>(1m));
