...
public sealed class Disintegration : CardModel, KnowledgeDemon.IChoosable
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new PowerVar<DisintegrationPower>(6m));
