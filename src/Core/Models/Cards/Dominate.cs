...
public sealed class Dominate : CardModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new DynamicVar("StrengthPerVulnerable", 1m));
