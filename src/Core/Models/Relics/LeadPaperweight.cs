...
public sealed class LeadPaperweight : RelicModel
{
	...
	{
		CardCreationOptions options = new CardCreationOptions(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<CardPoolModel>(ModelDb.CardPool<ColorlessCardPool>()), CardCreationSource.Other, CardRarityOddsType.RegularEncounter);
