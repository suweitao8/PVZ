...
public sealed class PaelsGrowth : RelicModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new StringVar("EnchantmentName", ModelDb.Enchantment<Clone>().Title.GetFormattedText()));
