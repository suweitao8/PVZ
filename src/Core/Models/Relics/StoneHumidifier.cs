...
public sealed class StoneHumidifier : RelicModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new MaxHpVar(5m));
	...
	public override IReadOnlyList<LocString> ModifyExtraRestSiteHealText(Player player, IReadOnlyList<LocString> currentExtraText)
	{
		...
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<LocString>(array);
	}
}
