...
public abstract class CharacterModel : AbstractModel
{
	...
	public IEnumerable<string> AssetPathsCharacterSelect => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[5] { CharacterSelectBg, CharacterSelectIconPath, IconTexturePath, CharacterSelectLockedIconPath, CharacterSelectTransitionPath });
