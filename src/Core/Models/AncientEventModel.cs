...
public abstract class AncientEventModel : EventModel
{
	...
	public IEnumerable<string> MapNodeAssetPaths => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[2] { MapIconPath, MapIconOutlinePath });
	...
	protected sealed override IReadOnlyList<EventOption> GenerateInitialOptionsWrapper()
	{
		...
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EventOption>(new EventOption(this, NEventRoom.Proceed, "PROCEED", false, true));
	}
