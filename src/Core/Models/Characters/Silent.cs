...
public sealed class Silent : CharacterModel
{
	...
	public override IEnumerable<CardModel> StartingDeck => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<CardModel>(new CardModel[12]
	{
	...
	public override IReadOnlyList<RelicModel> StartingRelics => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<RelicModel>(ModelDb.Relic<RingOfTheSnake>());
