...
public sealed class Ironclad : CharacterModel
{
	...
	public override IReadOnlyList<RelicModel> StartingRelics => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<RelicModel>(ModelDb.Relic<BurningBlood>());
