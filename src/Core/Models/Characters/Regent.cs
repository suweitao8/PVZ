...
public sealed class Regent : CharacterModel
{
	...
	public override IReadOnlyList<RelicModel> StartingRelics => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<RelicModel>(ModelDb.Relic<DivineRight>());
