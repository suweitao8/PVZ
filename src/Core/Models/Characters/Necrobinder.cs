...
public sealed class Necrobinder : CharacterModel
{
	...
	protected override IEnumerable<string> ExtraAssetPaths => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[2]
	{
		SceneHelper.GetScenePath("vfx/vfx_heal_osty"),
		SceneHelper.GetScenePath("creature_visuals/osty")
	});

	public override IEnumerable<CardModel> StartingDeck => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<CardModel>(new CardModel[10]
	{
	...
	public override IReadOnlyList<RelicModel> StartingRelics => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<RelicModel>(ModelDb.Relic<BoundPhylactery>());
