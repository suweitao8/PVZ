...
public sealed class Defect : CharacterModel
{
	...
	public override IReadOnlyList<RelicModel> StartingRelics => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<RelicModel>(ModelDb.Relic<CrackedCore>());
