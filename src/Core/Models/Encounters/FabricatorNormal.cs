...
public sealed class FabricatorNormal : EncounterModel
{
	...
	public override IReadOnlyList<string> Slots => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[5] { "bot1", "bot2", "fabricator", "bot3", "bot4" });
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters
	{
		get
		{
			...
			return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<MonsterModel>(array);
		}
	}

	protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
	{
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<(MonsterModel, string)>((ModelDb.Monster<Fabricator>().ToMutable(), "fabricator"));
	}
