...
public sealed class KnightsElite : EncounterModel
{
	...
	public override IEnumerable<EncounterTag> Tags => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EncounterTag>(EncounterTag.Knights);

	public override bool HasScene => true;

	public override IEnumerable<string>? ExtraAssetPaths => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<string>(ModelDb.Affliction<Hexed>().OverlayPath);
