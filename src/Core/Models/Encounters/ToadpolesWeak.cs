...
public sealed class ToadpolesWeak : EncounterModel
{
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<Toadpole>());
