...
public sealed class BowlbugsWeak : EncounterModel
{
	...
	public override IEnumerable<EncounterTag> Tags => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<EncounterTag>(EncounterTag.Workers);
	...
	public override IEnumerable<MonsterModel> AllPossibleMonsters => Bugs.Concat(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<MonsterModel>(ModelDb.Monster<BowlbugRock>()));
