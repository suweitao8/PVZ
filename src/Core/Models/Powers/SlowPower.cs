...
public sealed class SlowPower : PowerModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new DynamicVar("SlowAmount", 0m));
