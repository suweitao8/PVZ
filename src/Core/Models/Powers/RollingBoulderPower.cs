...
public sealed class RollingBoulderPower : PowerModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new DamageVar(5m, ValueProp.Unpowered));
	...
	public override async Task AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
	{
		...
		else
		{
			...
			{
				damageTasks.Add(DoDamage(choiceContext, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(c.Entity)));
			}));
