	...
	public override async Task AfterCardPlayed(PlayerChoiceContext context, CardPlay cardPlay)
	{
		if (cardPlay.Card is Soul)
		{
			...
			if (hittableEnemies.Count != 0)
			{
				...
				await CreatureCmd.Damage(context, new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(item), base.Amount, ValueProp.Unblockable | ValueProp.Unpowered, null, null);
			}
		}
	}
}
