...
public sealed class ReattachPower : PowerModel
{
	...
	{
		return from c in base.Owner.CombatState.GetTeammatesOf(base.Owner).Except(new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(base.Owner))
