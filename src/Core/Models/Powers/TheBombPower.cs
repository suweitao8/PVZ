...
public sealed class TheBombPower : PowerModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<DynamicVar>(new DamageVar(40m, ValueProp.Unpowered));
