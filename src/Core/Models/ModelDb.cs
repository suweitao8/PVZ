...
public static class ModelDb
{
	...
	public static IEnumerable<CardPoolModel> AllSharedCardPools => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<CardPoolModel>(new CardPoolModel[7]
	{
	...
	public static IEnumerable<CharacterModel> AllCharacters => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<CharacterModel>(new CharacterModel[5]
	{
		Character<Ironclad>(),
		Character<Silent>(),
		Character<Regent>(),
	...
	public static IEnumerable<EventModel> AllSharedEvents => _allSharedEvents ?? (_allSharedEvents = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventModel>(new EventModel[18]
	{
		Event<BrainLeech>(),
		Event<CrystalSphere>(),
		Event<DollRoom>(),
	...
	public static IEnumerable<AncientEventModel> AllSharedAncients => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<AncientEventModel>(AncientEvent<Darv>());
	...
	private static IEnumerable<PotionPoolModel> AllSharedPotionPools => _allSharedPotionPools ?? (_allSharedPotionPools = new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<PotionPoolModel>(new PotionPoolModel[4]
	{
	...
	private static IEnumerable<RelicPoolModel> AllSharedRelicPools => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<RelicPoolModel>(new RelicPoolModel[4]
	{
	...
	public static IEnumerable<OrbModel> Orbs => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<OrbModel>(new OrbModel[4]
	{
		Orb<LightningOrb>(),
		Orb<FrostOrb>(),
		Orb<DarkOrb>(),
	...
	public static IEnumerable<ActModel> Acts => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<ActModel>(new ActModel[4]
	{
		Act<Overgrowth>(),
		Act<Hive>(),
		Act<Glory>(),
	...
	public static IReadOnlyList<ModifierModel> GoodModifiers => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<ModifierModel>(new ModifierModel[9]
	{
		Modifier<Draft>(),
		Modifier<SealedDeck>(),
		Modifier<Hoarder>(),
	...
	public static IReadOnlyList<ModifierModel> BadModifiers => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<ModifierModel>(new ModifierModel[7]
	{
	...
	public static IReadOnlyList<IReadOnlySet<ModifierModel>> MutuallyExclusiveModifiers => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<IReadOnlySet<ModifierModel>>(new HashSet<ModifierModel>
	{
		Modifier<SealedDeck>(),
		Modifier<Draft>(),
		Modifier<Insanity>()
