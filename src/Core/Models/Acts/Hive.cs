...
public sealed class Hive : ActModel
{
	...
	public override IEnumerable<AncientEventModel> AllAncients => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<AncientEventModel>(new AncientEventModel[3]
	{
	...
	{
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EncounterModel>(new EncounterModel[21]
		{
