...
public sealed class Glory : ActModel
{
	...
	public override IEnumerable<EventModel> AllEvents => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventModel>(new EventModel[7]
	{
	...
	{
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EncounterModel>(new EncounterModel[18]
		{
