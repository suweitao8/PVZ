...
public sealed class Overgrowth : ActModel
{
	...
	public override IEnumerable<EncounterModel> BossDiscoveryOrder => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EncounterModel>(new EncounterModel[3]
	{
	...
	public override IEnumerable<AncientEventModel> AllAncients => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<AncientEventModel>(ModelDb.AncientEvent<Neow>());

	public override IEnumerable<EventModel> AllEvents => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EventModel>(new EventModel[13]
	{
	...
	{
		return new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<EncounterModel>(new EncounterModel[22]
		{
