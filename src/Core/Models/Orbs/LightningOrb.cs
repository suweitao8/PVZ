...
public class LightningOrb : OrbModel
{
	...
	private async Task<IEnumerable<Creature>> ApplyLightningDamage(decimal value, Creature? target, PlayerChoiceContext choiceContext)
	{
		...
		IReadOnlyList<Creature> targets = ((target == null) ? new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(base.Owner.RunState.Rng.CombatTargets.NextItem(list)) : new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<Creature>(target));
