...
public class MegaSkeleton : MegaSpineBinding
{
	...
	protected override IEnumerable<string> SpineMethods => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[6] { "find_bone", "get_bounds", "get_data", "set_skin", "set_skin_by_name", "set_slots_to_setup_pose" });
