...
public class MegaBone : MegaSpineBinding
{
	...
	protected override IEnumerable<string> SpineMethods => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[4] { "get_data", "set_rotation", "set_scale_x", "set_scale_y" });
