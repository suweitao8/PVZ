...
public class MegaAnimationState : MegaSpineBinding
{
	...
	protected override IEnumerable<string> SpineMethods => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[7] { "add_animation", "add_empty_animation", "apply", "get_current", "set_animation", "set_time_scale", "update" });
