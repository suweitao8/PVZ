...
public class MegaTrackEntry : MegaSpineBinding
{
	...
	protected override IEnumerable<string> SpineMethods => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[9] { "get_animation", "get_animation_end", "get_track_complete", "get_track_time", "is_complete", "set_loop", "set_time_scale", "set_track_time", "set_mix_duration" });
