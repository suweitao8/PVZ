...
public static class TmpSfx
{
	...
	public static IEnumerable<string> BattleStart => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[2] { "battle_start_1.mp3", "battle_start_2.mp3" });

	public static IEnumerable<string> PotionSlosh => new global::MegaCrit.Sts2.Core.Collections.ReadOnlyArray<string>(new string[3] { "potion_slosh_1.mp3", "potion_slosh_2.mp3", "potion_slosh_3.mp3" });
