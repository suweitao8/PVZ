...
public partial class NCombatRoom : Control, IScreenContext, IRoomWithProceedButton
{
	...
	public static IEnumerable<string> AssetPaths => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<string>("res://scenes/rooms/combat_room.tscn");
