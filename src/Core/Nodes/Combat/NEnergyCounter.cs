...
public partial class NEnergyCounter : Control
{
	...
	public static IEnumerable<string> AssetPaths => new global::MegaCrit.Sts2.Core.Collections.ReadOnlySingleElementList<string>("res://materials/ui/energy_orb_dark.tres");
